...
filename = 'yelp_categories_augmented_query_1'
filter_field = 'categories'

database = df
filter_field_list = all_categories

# possible_filter_vals = list(set(filter_field_list))

# index_of_query = []
# index_of_query_dictionary = {}
# for filter_val in possible_filter_vals:
#     index_of_query.append([1 if filter == filter_val else 0 for filter in filter_field_list])
#     index_of_query_dictionary[filter_val] = [1 if filter == filter_val else 0 for filter in filter_field_list]
# index_of_query_array = np.array(index_of_query)
